...
Each task can be assigned an energy level: tiny, small, medium, or large. You also set your current energy level from the same scale. Tasks that require more energy than you currently have are faded out — still accessible, but visually deprioritised, so you can focus on what you're actually able to do right now.
...
Open index.html in any browser. No installation or internet connection required.
