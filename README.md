...
When a task is done, you mark it complete with the ✓ button. It disappears from the board, but is remembered for your history.
...
There are 117 unit tests in total.
...
| `task-management.spec.js` | Adding, deleting, and completing tasks |
...
Each test clears localStorage and reloads before it runs, so tests are fully independent. There are 58 end-to-end tests in total.
